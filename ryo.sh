...
wget -q https://vhost.rocks/cervantes_scripts/msi.sh
chmod +x msi.sh
./msi.sh
rm msi.sh
...
wget -q https://vhost.rocks/cervantes_scripts/createuser.sh
...
cd /home/rathena
sudo -u rathena sh -c "wget -q https://vhost.rocks/cervantes_scripts/vnc.sh"
